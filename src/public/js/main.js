            ...
            item.addEventListener("click", function (e) {
                ...
                switch (itemText) {
                    case "Thông tin cá nhân":
                        alert(
                            "Tính năng thông tin cá nhân sẽ được tích hợp sau."
                        );
                        break;
                    case "Bài viết đã lưu":
                        alert(
                            "Tính năng bài viết đã lưu sẽ được tích hợp sau."
                        );
                        break;
                    case "Lịch sử hoạt động":
                        alert(
                            "Tính năng lịch sử hoạt động sẽ được tích hợp sau."
                        );
                        break;
                    case "Đăng xuất":
    ...
    topicButtons.forEach((btn) => {
        btn.addEventListener("click", function () {
            topicButtons.forEach((b) =>
                b.classList.remove("ws-setup__topic--active")
            );
...
navWPSetup.forEach((nav) => {
    nav.addEventListener("click", function () {
        ...
        if (nav === "system") {
            document
                .querySelector(".wp-setup__nav-system")
                .classList.remove("d-none");
            document
                .querySelector(".wp-setup__nav-custom")
